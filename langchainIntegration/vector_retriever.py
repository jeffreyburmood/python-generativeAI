...
# Retrieve context
# The context is a list of Document objects returned by the similarity_search method. The Document content contains
# the movie plot and the node's propertiesiFull definition for property (opens in a new tab)A named value stored on
# a node or a relationship. are returned as metadata.
